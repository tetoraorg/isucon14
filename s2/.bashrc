...
. "$HOME/.local/bin/env"
# BEGIN ANSIBLE MANAGED BLOCK for s2
export SERVER_NAME=s2
export REPOSITORY=tetoraorg/isucon14
export REPOSITORY_DIR=/home/isucon/repo
...
# END ANSIBLE MANAGED BLOCK for s2
